...
import { Loader2, Sparkles, TrendingDown, Info, Star, BookOpen } from "lucide-react"
    ...
    return (
        <StyledCard variant="amber">
            <StyledCardHeader
                ...
                description={`${festivalEvents.length} Indian festivals • Gold buying season analysis`}
                variant="amber"
                action={
                            ...
                            <DialogContent className="max-w-2xl">
                                <DialogHeader>
                                    <DialogTitle className="flex items-center gap-3 text-xl">
                                        ...
                                        Festival Statistics Guide
                                    </DialogTitle>
                                    <DialogDescription>Understanding gold demand during Indian festivals</DialogDescription>
                                </DialogHeader>
                                <div className="space-y-4 mt-4">
                                    <div className="p-4 rounded-xl bg-linear-to-br from-amber-50 to-orange-50 border border-amber-100">
                                        <h4 className="font-bold text-amber-800 mb-2 flex items-center gap-2">
                                            <Star className="h-4 w-4" />
                                            Festival Gold Demand
                                        </h4>
                                        <p className="text-sm text-amber-700">
                                            Indian festivals drive significant gold demand. Diwali season (Dhanteras to Diwali)
                                            typically sees the highest gold purchases of the year.
                                        </p>
                                    </div>
                                    <div className="p-4 rounded-xl bg-slate-50 border">
                                        <h4 className="font-bold text-slate-800 mb-2">Key Festivals for Gold</h4>
                                        <ul className="text-sm text-slate-600 space-y-2">
                                            <li>• <strong>Dhanteras</strong>: Biggest gold buying day in India</li>
                                            <li>• <strong>Akshaya Tritiya</strong>: Most auspicious day for gold purchase</li>
                                            <li>• <strong>Diwali</strong>: Festival of lights, peak buying season</li>
                                            <li>• <strong>Onam/Pongal</strong>: Regional harvest festivals</li>
                                        </ul>
                                    </div>
                                </div>
                            </DialogContent>
                        ...
                        {overallStats && (
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <motion.div
                                    ...
                                    className="p-4 bg-linear-to-br from-amber-50 to-yellow-50 rounded-xl border border-amber-200"
                                >
