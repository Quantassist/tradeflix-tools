...
export function BacktestResultsChart({ equityCurve, monthlyReturns, initialCapital, finalCapital }: BacktestResultsChartProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Drawdown Chart */}
      <Card className="border-2 shadow-xl">
        <CardHeader className="bg-linear-to-r from-red-500 to-orange-600 text-white rounded-t-lg">
          <CardTitle className="text-2xl flex items-center gap-2">
      ...
      {/* Monthly Returns */}
      <Card className="border-2 shadow-xl">
        <CardHeader className="bg-linear-to-r from-green-500 to-emerald-600 text-white rounded-t-lg">
          <CardTitle className="text-2xl flex items-center gap-2">
